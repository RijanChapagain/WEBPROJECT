...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="Gurus of Fitness">
    <meta name="description" content="Gurus of Fitness">
    ...
    <div class="container">
        <div class="row">
            ...
            <a href="<?php echo $value; ?>">
                <img src="<?php echo $value; ?>" alt="Real State" width="300px" align="left" hspace="5px" vspace="5px">
            </a>
            <!-- loop end -->
            <?php
            }
