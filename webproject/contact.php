...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="Unite Limited | Real State Business | Buy House | Buy Land">
    <meta name="description" content="Unite Limited | Real State Business | Buy House | Buy Land">
  ...
  <body>
   ...
   <div class="container-fluid bg-white" style="padding: 40px;">
    <div class="container">
        <div class="row">
            <div class="col-md-9">
            <strong>United Limited</strong>
            <p><i class="fa fa-map-marker"></i> Bharatpur-12, Chitwan, Nepal</p>
            <p><i class="fa fa-envelope"></i> +977 9855099887</p>
            <p><i class="fa fa-envelope"> </i> united.limited@gmail.com</p>
            <p><i class="fa fa-globe"></i> <a href="https://www.unitedlimited.com.np">
              www.unitedlimited.com.np</a></p>
            ...
            {
              $to='eyedust2000@gmail.com'; //Your email to receive email
              $name=$_POST['fname'];
              $email=$_POST['email'];
