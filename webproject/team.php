        ...
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-4">
                    <img src="assets/team/3.jpg" alt="" class="img-thumbnail">
                        <p>Receptionist</p>
                        <p>Sahil Chaudhary</p>
                ...
                <div class="row">
                    <div class="col-md-4">
                    <img src="assets/team/4.jpg" alt="" class="img-thumbnail">
                        <p>Trainer</p>
                        <p>Lipsa Mahato</p>
                    </div>
                    <div class="col-md-4">
                    <img src="assets/team/5.jpg" alt="" class="img-thumbnail">
                        <p>Trainer</p>
                        <p>Chiba Shrestha</p>
                    </div>
                    <div class="col-md-4">
                    <img src="assets/team/6.jpg" alt="" class="img-thumbnail">
                        <p>Trainer</p>
                        <p>Rose Chaudhary</p>
