  ...
  <body>
   ...
   <div class="jumbotron jumbotron-fluid text-center" style="margin-bottom: 0px;">
    <div class="container">
        ...
        <hr class="my-2">
        <p>In a world where health and well-being have become paramount concerns for individuals from all walks of life, the quest for physical and mental fitness has never been more crucial. Amidst this growing awareness, the Gurus of Fitness have emerged as a beacon of holistic wellness, offering a comprehensive suite of services designed to empower individuals on their journey towards a healthier, happier life.</p>
        <p class="lead">
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p>For the basic membership in Gurus of Fitness</p>
